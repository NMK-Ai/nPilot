...
class NoEntryAlert(Alert):
  def __init__(self, alert_text_2: str, visual_alert: car.CarControl.HUDControl.VisualAlert=VisualAlert.none):
    super().__init__("القائد الآلي غير متوف", alert_text_2, AlertStatus.normal,
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.laneChangeBlocked: {
    ET.WARNING: Alert(
      ...
      "انتبه ربما لا ترا المركبة في المرآه",
      AlertStatus.userPrompt, AlertSize.small,
  ...
  EventName.gpsMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("عطل في نظام تحديد المواقع العالمي (GPS)", "مشكلة محتملة في الجهاز"),
  },
  ...
  EventName.pedalPressed: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage),
    ET.NO_ENTRY: NoEntryAlert("الضغط على الدواس",
  ...
  EventName.outOfSpace: {
    ...
    ET.NO_ENTRY: NoEntryAlert("الذاكرة ممتلئةا"),
  },
  ...
  EventName.overheat: {
    ...
    ET.SOFT_DISABLE: soft_disable_alert("Sالنظام ساخن"),
  ...
  EventName.roadCameraError: {
    ET.PERMANENT: NormalPermanentAlert("خطأ في الكاميرا - الطريق",
                                       duration=1.,
                                       creation_delay=30.),
  },

  EventName.wideRoadCameraError: {
    ET.PERMANENT: NormalPermanentAlert("خطأ في الكاميرا - عيون القطط",
                                       duration=1.,
                                       creation_delay=30.),
  },

  EventName.driverCameraError: {
    ET.PERMANENT: NormalPermanentAlert("خطأ في الكاميرا - السائق",
                                       duration=1.,
                                       creation_delay=30.),
  },
  ...
  EventName.canBusMissing: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("الظفيرة مفصولة"),
    ET.PERMANENT: Alert(
      "الظفيرة مفصولة: التوصلات موصلة بالخطاء الأرجح",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, 1., creation_delay=1.),
    ET.NO_ENTRY: NoEntryAlert("الظفيرة مفصولة: إفحص التوصلات"),
  },

  EventName.steerUnavailable: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("خطاء في نظام البقاء في المسار: أعد تشغيل المركبة"),
    ET.PERMANENT: NormalPermanentAlert("خطاء في نظام البقاء في المسار: أعد تشغيل المركبة للتفعيل"),
    ET.NO_ENTRY: NoEntryAlert("خطاء في نظام البقاء في المسار: أعد تشغيل المركبة"),
  },

  EventName.brakeUnavailable: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("فشل في تثبيت السرعة: أعد تشغيل المركبة"),
  ...
  EventName.relayMalfunction: {
    ...
    ET.PERMANENT: NormalPermanentAlert("عطل في الظفيرة", "افحص التوصيلات"),
  ...
  EventName.slowingDownSpeed: {
    ET.PERMANENT: Alert("أخفض السرعة","", AlertStatus.normal, AlertSize.small,
