...
Security
Insights
nasser/launch_chffrplus.sh
@nasser2019
nasser2019 Initial commit
Latest commit 015db7e 4 days ago
 History
 1 contributor
Executable File  221 lines (173 sloc)  6.75 KB
...
if [ "$(getprop persist.sys.locale)" != "en-EU" ]; then
    setprop persist.sys.locale en-EU
    setprop persist.sys.language en
    setprop persist.sys.country EU
